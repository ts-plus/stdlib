type KindFromObj<F extends HKT, __> = HKT.Kind<
  F,
  HKT.Infer<F, "R", __>,
  HKT.Infer<F, "E", __>,
  HKT.Infer<F, "A", __>
...
export interface MatchFn<F extends HKT, N extends string> {
  <
...
export interface MatchInFn<F extends HKT, N extends string> {
  <X extends { [tag in N]: string }>(): {
    <
      K extends {
        [k in X[N]]: (
