...
/**
 * @tsplus static ImmutableArray/Ops matchIn
 */
export const matchIn = Matchers.matchIn

/**
 * @tsplus static ImmutableArray/Ops matchMorph
 */
export const matchMorph = Matchers.matchMorph

/**
 * @tsplus static ImmutableArray/Ops matchTag
 */
export const matchTag = Matchers.matchTag

/**
 * @tsplus static ImmutableArray/Ops matchTagIn
 */
